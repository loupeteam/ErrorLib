...
export WIN32_AS_PROJECT_PATH := "C:\Projects\Loupe\ErrorLib\example\AsProject\ErrorProg"
export WIN32_AS_SYSTEM_PATH := "C:\BrAutomation\AS\System"
export WIN32_AS_VC_PATH := "C:\BrAutomation\AS411\AS\VC"
export WIN32_AS_TEMP_PATH := "C:\Projects\Loupe\ErrorLib\example\AsProject\ErrorProg\Temp"
export WIN32_AS_BINARIES_PATH := "C:\Projects\Loupe\ErrorLib\example\AsProject\ErrorProg\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/4.9/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/ErrorProg.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'Build'   
